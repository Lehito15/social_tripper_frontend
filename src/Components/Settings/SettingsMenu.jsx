  ...
  return (
    <div className="settings-menu stats-box">
      ...
      <div className="settings-options">
        ...
        >
          <img src={`${process.env.PUBLIC_URL}/user-icon.png`} alt="Icon" className="icon" />
        ...
        >
          <img src={`${process.env.PUBLIC_URL}/show-password.png`} alt="Icon" className="icon" />
        ...
        >
          <img src={`${process.env.PUBLIC_URL}/full-biceps.png`} alt="Icon" className="icon" />
