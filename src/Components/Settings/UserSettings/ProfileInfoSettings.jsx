...
import PhoneInput from '../../UserLogin/Register/PhoneInput';
import CountrySelect from '../../UserLogin/Register/CountrySelect';
...
function ProfileInfoSettings({ user, onSave }) {
  ...
  const [profileImageName, setProfileImageName] = useState(user.profilePictureUrl || '')
  ...
  // Jeśli są błędy, wyświetl komunikaty i przerwij zapis
      ...
      <div className="profile-info-edit">
        <div className='change-photo-container'>
          ...
          <div className='change-photo-buttons'>
            ...
            />
            <label htmlFor="upload-photo" className='uplod-button'>Upload new</label>
            <button 
              className='delete-avatar uplod-button' 
