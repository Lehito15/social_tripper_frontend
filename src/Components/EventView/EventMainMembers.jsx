...
const removeUserFromEvent = async (userUuid) => {
  try {
    ...
    await sendToBackend(endpoint, 'DELETE', JSON.stringify(userRequestEventDTO));
    setReload(!reload);
  ...
  return (
    <div>
      ...
      <div className="all-members-container">
        <Members title={'All members'} members={data.members} ownerUuid={event.owner.uuid}  remove={isOwner ? removeUserFromEvent : null} />
      </div>
    </div>
