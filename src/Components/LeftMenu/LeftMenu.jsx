  ...
  const menuItems = useMemo(
    () => [
      ...
      },
      {
        ...
        activeIcon: "events-active.png",
      },
      {
        path: "/relations",
        label: "Relations",
        icon: "relation_icon.png",
        activeIcon: "relations-active.png",
      },
      {
        path: "/groups",
        label: "Groups",
        icon: "groups_icon.png",
        activeIcon: "groups-active.png",
      },
      {
        path: "/memories",
        label: "Memories",
        icon: "memories_icon.png",
        activeIcon: "memories-active.png",
      },
      {
        path: "/explore",
        label: "Explore",
        icon: "explore_icon.png",
        activeIcon: "explore-active.png",
      },
    ],
    []
  );
                ...
                <li key={index}>
                  ...
                  >
                    <div className="menu-item">
                      <div
                        className={`icon-container ${activeIndex === index ? "icon-active-container" : ""}`}
                      >
                        <img
                          src={
                            activeIndex === index
